...
const labels = [
  { id: 0, value: 'all', label: '전체 동의', iconType: 'CHECK_BOX', name: 'chk_all' },
  {
    id: 1,
    value: 'must1',
    label: '서비스 이용약관 동의',
  ...
  { id: 3, value: 'must3', label: '만 14세 이상입니다.', iconType: 'CHECK_BOX', name: 'chk_age' },
...
const infoProps2 = {
  text: [
    {
      id: 0,
      content: '하단에 입력하시는 계정 정보로 Pine Work 최고관리자 권한에 로그인 하실 수 있습니다.',
    },
    {
      id: 1,
      content: '최고관리자는 상품 관리/변경 및 서비스 관리 등 Pine Work의 모든 메뉴를 관리하실 수 있습니다.',
    },
  ],
};
const infoProps3 = {
  ...
  text: [
    ...
    {
      id: 2,
      content: '관련 문의사항은 고객센터 또는 02-2202-0700으로 연락해 주시기 바랍니다.',
    },
  ],
};
      ...
      <div className={styles.container}>
        ...
        <div style={{ display: step === 1 || step === 2 ? 'block' : 'none' }} className={styles.header}>
          ...
          <p className={styles.sub_title}>
            No .1 근로시간관리 솔루션 MOffice를 이제 클라우드 서비스 Pine Work로 경험해보세요!
          </p>
        </div>

        <div className={styles.area_text} style={{ display: step === 1 || step === 2 ? 'block' : 'none' }}>
          <StepNav step={step} />
        </div>
